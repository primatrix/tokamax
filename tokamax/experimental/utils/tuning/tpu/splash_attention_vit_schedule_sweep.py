...
_NATIVE_SHARED_BODY = _NATIVE_DQ_AND_KV_IDS | dict(
    bwd_compact_segment_ids=True, bwd_single_segment_mask_body=True,
)
...
def variants(phase="backward"):
  ...
  return [
      ...
      ("qtile1024_nested_u4", _DQ_DK_FIRST | dict(bwd_block_q_compute=1024, bwd_kv_unroll=4, bwd_qtile_nested=True)),
      ("qtile1024_acc_carry", _DQ_DK_FIRST | dict(bwd_block_q_compute=1024, bwd_qtile_nested=True, bwd_qtile_accumulator_carry=True)),
      ("qtile1024_acc_carry_u2", _DQ_DK_FIRST | dict(bwd_block_q_compute=1024, bwd_kv_unroll=2, bwd_qtile_nested=True, bwd_qtile_accumulator_carry=True)),
      ("qtile1024_acc_carry_u4", _DQ_DK_FIRST | dict(bwd_block_q_compute=1024, bwd_kv_unroll=4, bwd_qtile_nested=True, bwd_qtile_accumulator_carry=True)),
      ...
      ("qtile512_nested_u4", _DQ_DK_FIRST | dict(bwd_block_q_compute=512, bwd_kv_unroll=4, bwd_qtile_nested=True)),
      ("qtile512_acc_carry_u4", _DQ_DK_FIRST | dict(bwd_block_q_compute=512, bwd_kv_unroll=4, bwd_qtile_nested=True, bwd_qtile_accumulator_carry=True)),
      ...
      ("dq_and_ids_compact_single", _NATIVE_DQ_AND_KV_IDS | dict(bwd_compact_segment_ids=True, bwd_single_segment_mask_body=True)),
      ("native_shared_c512", _NATIVE_SHARED_BODY | dict(block_kv_dkv_compute=512)),
      ("native_shared_c256", _NATIVE_SHARED_BODY | dict(block_kv_dkv_compute=256)),
      ("native_staged_c512", _NATIVE_SHARED_BODY | dict(bwd_staged_kv_pipeline=True, block_kv_dkv_compute=512)),
      ("native_staged_c1024", _NATIVE_SHARED_BODY | dict(bwd_staged_kv_pipeline=True)),
      ("native_interleaved_c512", _NATIVE_SHARED_BODY | dict(bwd_staged_kv_pipeline=True, bwd_staged_kv_interleave=True, block_kv_dkv_compute=512)),
      ("native_interleaved_c1024", _NATIVE_SHARED_BODY | dict(bwd_staged_kv_pipeline=True, bwd_staged_kv_interleave=True)),
      ("native_staged_wrap_c512", _NATIVE_SHARED_BODY | dict(bwd_staged_kv_pipeline=True, bwd_staged_kv_wrap_tail=True, block_kv_dkv_compute=512)),
      ...
      ("native_staged_refs_c256", _NATIVE_SHARED_BODY | dict(bwd_staged_kv_pipeline=True, bwd_staged_kv_wrap_tail=True, bwd_staged_kv_ref_buffers=True, block_kv_dkv_compute=256)),
      ("native_staged_refs_c512", _NATIVE_SHARED_BODY | dict(bwd_staged_kv_pipeline=True, bwd_staged_kv_wrap_tail=True, bwd_staged_kv_ref_buffers=True, block_kv_dkv_compute=512)),
      ("native_interleaved_refs_c256", _NATIVE_SHARED_BODY | dict(bwd_staged_kv_pipeline=True, bwd_staged_kv_interleave=True, bwd_staged_kv_wrap_tail=True, bwd_staged_kv_ref_buffers=True, block_kv_dkv_compute=256)),
      ("native_interleaved_refs_c512", _NATIVE_SHARED_BODY | dict(bwd_staged_kv_pipeline=True, bwd_staged_kv_interleave=True, bwd_staged_kv_wrap_tail=True, bwd_staged_kv_ref_buffers=True, block_kv_dkv_compute=512)),
